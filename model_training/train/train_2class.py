...
This script trains a convolutional neural network (EEGCNN) to classify
EEG data into one of two classes: FORWARD or STOP.

Dependencies:
    json, torch, matplotlib, numpy, os, EEGCNN, EEGDataset, sklearn
"""

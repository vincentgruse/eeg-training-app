"""
train_lstm_5class.py

This script trains an LSTM model to classify EEG windows into five
movement directions: BACKWARD, FORWARD, LEFT, RIGHT, STOP.
...
MODEL_PATH = "model_training/outputs/models/lstm_5class.pt"
...
# MODEL
# ==============================================================================
model = EEGLSTM(num_classes=5).to(DEVICE)
...
plt.title("Confusion Matrix - LSTM 5-Class")
plt.savefig(f"{PLOT_DIR}/lstm_5class_confusion.png")
plt.close()

# Accuracy Plot.
plt.plot(val_accuracies, label="Val Acc")
plt.title("Validation Accuracy - LSTM 5-Class")
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.grid()
plt.legend()
plt.savefig(f"{PLOT_DIR}/lstm_5class_accuracy.png")
plt.close()

# Loss Plot.
plt.plot(train_losses, label="Train Loss")
plt.plot(val_losses, label="Val Loss")
plt.title("Loss Curve - LSTM 5-Class")
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.grid()
plt.legend()
plt.savefig(f"{PLOT_DIR}/lstm_5class_loss.png")
plt.close()
